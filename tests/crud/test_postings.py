...
class TestCredit(object):
    ...
    def test_create_credit_no_pic(self):
        ...
        response = self.credit_crud.create(base.SAMPLE_URL, self.amount, self.mv_url)
    ...
    def test_create_credit_with_optional_pic(self):
        ...
        response = self.credit_crud.create(base.SAMPLE_URL, self.amount, self.mv_url, self.pic)
    ...
    def test_create_credit_with_optional_kwargs_add_top_level_params(self):
        ...
        response = self.credit_crud.create(base.SAMPLE_URL, self.amount, self.mv_url, **self.additional_params)
